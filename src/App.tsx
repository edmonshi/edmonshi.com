    ...
    <div className="App">
      ...
      <main>
        <section id="home">
          ...
          <div id="contact">
            <a href="mailto:edmonshi0614@gmail.com" target="_blank" rel="noreferrer" draggable={false} onMouseDown={(e) => e.preventDefault()}>
            ...
            <a href="https://www.github.com/edmonshi/" target="_blank" rel="noreferrer" draggable={false} onMouseDown={(e) => e.preventDefault()}>
            ...
            <a href="https://www.linkedin.com/in/edmonshi/" target="_blank" rel="noreferrer" draggable={false} onMouseDown={(e) => e.preventDefault()}>
